...
| HR-CC-005 | 用户 2026-07-26 | 非训练 background cleanup、不持续 scan；回前台 eligible 自动恢复 | E17-7b AC：Home / return / process recreation | E17-7b final executable source 的 AVD lifecycle / scan-count / cleanup / foreground-return evidence |
