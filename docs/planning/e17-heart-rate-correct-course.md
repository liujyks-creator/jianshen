...
E17 复用已经冻结的浮动胶囊视觉与互动，优先稳定、可解释、用户可见、手动可恢复；自动重连不是默认前置。
...
- `docs/design/e16-heart-rate-floating-capsule-decision.md`
- `docs/design/e16-3-heart-rate-ui-html/README.md`
...
冻结的是视觉与互动，不是旧 runtime 设计。

## 7. E17 解锁规则

1. E17-0 reviewed / merged 后才可开始 E17-1。
2. E17-1 reviewed / merged，并完成该 Story 明确要求的 Band 9 真机复验后，才可开始 E17-2。
3. E17-2 reviewed / merged 后才可开始 E17-3。
4. E17-3 reviewed / merged 后才可开始 E17-4。
5. E17-4 implementation readiness reviewed / merged 且结论通过后，才能创建正式 production implementation Story。
...
- 唯一 freeze 范围在 retrospective、E17 计划、decision log 与 architecture 一致。
