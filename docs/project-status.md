...
1. 完成 `codex/e10-3-workout-controls-reachability` 分支 Review Gate。
2. 下一轮建议进入 E10.4：训练记录闭环前置。
3. 后续按 E11/E12/E13 依次处理手动心率输入、真实统计图表和声音/女声 cue。
