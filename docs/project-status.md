...
5. E12 Stats / Records 可基于 E10.14 的 `timedRestExtensionRecords` 做真实额外休息统计、总统计、非心率图表和同日多轮运动分析；不得回填或修改原计划结构。平均心率趋势必须等待明确来源的设备心率或可选手动心率数据；如果两者都没有，历史页和趋势页显示未获取心率，不画假趋势。
