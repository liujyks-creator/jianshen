...
27. E11.3：放弃首版心率显示、录入和统计；撤下执行页心率卡片、手动输入、历史心率占位和 debug smoke 入口，仅保留未来模型边界。（Implemented）
28. E12.1：真实记录与基础统计。（Implemented）
29. E12.2a：非心率历史图表与聚合趋势。（Implemented）
