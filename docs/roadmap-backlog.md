...
15. E14.4-2b-6c smoke / visual QA：next if needed。继续验证 v2 1 target、2 targets、3-5 targets、work/rest/custom、between-round rest、warmup、cooldown、legacy plan、pause/resume、rest extension 和 reduce-motion。
